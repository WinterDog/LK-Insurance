...
abstract class image {
	...
	/**
	 * Factory pattern to load selected driver.
	 * $image and $options are passed
	...
	/**
	 * Checks if the drivers in the array parameter could be used.
	 * Returns first
	 * found one
	 * 
	 * @param array $drivers        	
	...
	/**
	 * Returns an array.
	 * Element 0 - image resource. Element 1 - width. Element 2 - height.
	...
	/**
	 * Checks if PHP needs some extra extensions to use the image driver.
	 * This
	 ...
	 * This static method should be implemented into
	...
	/**
	 * Resize image to fit in given resolution.
	...
	/**
	 * Resize and crop the image to fit in given resolution.
	 * Returns TRUE on
	...
	/**
	 * Apply a PNG or GIF watermark to the image.
	 * $top and $left parameters sets
	...
	/**
	 * Should output the image.
	 * Second parameter is used to pass some options like
	...
	/**
	 * This method should create a blank image with selected size.
	 * Should returns
	...
	/**
	 * This method should create an image from source image.
