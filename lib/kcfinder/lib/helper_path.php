...
class path {
	...
	/**
	 * Get the absolute URL path of the given one.
	 * Returns FALSE if the URL
	...
	/**
	 * Resolve full filesystem path of given URL.
	 * Returns FALSE if the URL
	 * cannot be resolved
	 * 
	 * @param string $url        	
	 ...
	 * On Windows servers backslash will be replaced
