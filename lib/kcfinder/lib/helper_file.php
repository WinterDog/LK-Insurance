...
class file {
	...
	/**
	 * Checks if the given file is really writable.
	...
	/**
	 * Get inexistant filename based on the given filename.
	 * If you skip $dir
	...
	/**
	 * Normalize given filename.
	 * Accented characters becomes non-accented and
