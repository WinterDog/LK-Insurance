		...
		<td>
			<div class="input-group input-group-sm w300">
				...
				<input
					...
					program_id="{$tariff_program->id|default}"
		...
		{if (isset($age_groups))}
			{foreach $age_groups as $age_group}
				...
				{include "inc/dms/clinic_program_price.tpl"
					price=$tariff_program->tariffs[$age_group['age_title']]['price']|default}
	...
	{include "inc/dms/clinic_program_data.tpl"
		...
		sizeof_groups=sizeof($age_groups)|default:0}