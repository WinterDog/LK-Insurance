	...
	>
			...
			<h5 class="panel-title" company_name>
				<a
					{if (isset($tariff_clinic))}
						...
						href="#panel-collapse-adult-{$tariff_clinic->id}"
					{/if}
				>
		...
		<div
			{if (isset($tariff_clinic))}
				...
				id="panel-collapse-adult-{$tariff_clinic->id}"
			{/if}
		>
			<div class="panel-body">
				...
				<table class="table table-condensed">
						...
						<tr class="active">
							<th>
								...
								<button
									...
									type="button"
									onclick="DmsClinicAdultAddProgram(this);"
								>
					...
					<tbody clinic-adult-programs>
						{if (isset($tariff_clinic))}
							{foreach $tariff_clinic->programs as $tariff_program}
								{include "inc/dms/clinic_adult_tariff_program.tpl" tariff_program=$tariff_program|default:null}
							{/foreach}
						{/if}
					</tbody>
				</table>
