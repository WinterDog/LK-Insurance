	<p>Приветствуем Вас, {$user->nickname}!</p>
	
	<p>Спасибо за регистрацию на сайте <strong><a href="{$_CFG['contacts']['url']}" target="_blank">{$_CFG['ui']['site_name']}</a></strong>! На нашем портале Вы сможете:</p>

	<ul>
		<li>рассчитать стоимость страховки по ведущим страховым компаниям;</li>
	...
	<p>Изменить пароль и другие данные Вашей учётной записи Вы можете в личном кабинете:</p>
