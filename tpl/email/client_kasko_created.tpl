	...
	<p>
		Ваша заявка на расчёт стоимости полиса КАСКО на сайте
		<strong><a href="{$_CFG['contacts']['url']}" target="_blank">{$_CFG['ui']['site_name']}</a></strong>
		успешно зарегистрирована.
		В течение суток наш менеджер сделает расчёт по нескольким страховым компаниям
		и отправит варианты Вам по электронной почте.
	</p>
