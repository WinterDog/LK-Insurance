...
{block "content_wrap" prepend}
	...
	<section>
		<div class="header-bgr bgr-property-flat">
			<div class="page-title">
				<div class="container-fluid content-wrap-h max-width-lg">
					<a class="page-subsection active" href="/property_calc_c/">
						<h4>Квартира</h4>
					</a>
					<a class="page-subsection" href="/property_calc_c_house/">
						<h4>Дом</h4>
					</a>
				</div>
			</div>
			...
			<div class="container-fluid content-wrap-h max-width-lg">
				<div class="header-block">
					<h1>Узнайте, сколько стоит страховка Вашей квартиры.<br>Заявки обрабатываются в течение суток.</h1>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			*}
			...
			<form action="/property_policy_c/submit" id="query-form">
		
				<div id="step-div-1" wd-id="step-div">
		
					{include "inc/property/calc.tpl" property_type_id=1}
